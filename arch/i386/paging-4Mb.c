 ...
 *
 */
void __attribute__((noreturn)) __attribute__((optimize("-fomit-frame-pointer"))) setup_4Mb_initial_paging(void) {
    /*********************************************************************/
    ...
    asm volatile("push $higher_half_cont\n\t"
                 "ret\n\t");
    /* Make compiler happy */
    for (;;) {
        ;
 ...
 *
 */
void __attribute__((optimize("-fomit-frame-pointer"))) higher_half_cont(void) {
